                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:mx-12 lg:max-w-screen-2xl ">
                    ...
                    >
                        <div className="relative">
                            {/* Decorative rings */}
                            <div className="absolute inset-0 -m-4 rounded-full border border-[#4C9EEB]/8 animate-pulse" />
                            <div className="absolute inset-0 -m-8 rounded-full border border-[#7C4DFF]/5" />
                            <div className="absolute inset-0 -m-12 rounded-full border border-[#22D3EE]/2" />

                            {/* Glow effect */}
                            <div className="absolute inset-0 bg-gradient-to-br from-[#4C9EEB]/20 via-[#7C4DFF]/20 to-[#22D3EE]/20 rounded-full blur-2xl" />
                            ...
                            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-100 lg:h-100 rounded-full overflow-hidden border-2 border-white/10">
                                {!imageError ? (
                                    <>
                                        {!imageLoaded && (
                                            <div className="absolute inset-0 bg-gradient-to-br from-[#12151B] to-[#0B0F14] animate-pulse flex items-center justify-center">
